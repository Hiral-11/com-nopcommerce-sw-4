...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.enterFirstName("Sun");
        registerPage.enterLastName("Moon");
        registerPage.enterEmail("Sunmoon@gmail.com");
        registerPage.enterPassword("MoonSun@123");
        registerPage.enterConfirmPassword("MoonSun@123");
        ...
        signInPage.emailId("Sunmoon@gmail.com");
        signInPage.password("MoonSun@123");
        ...
        //checkOutPage.enterFirstName("shraddha");
        //checkOutPage.enterLastName("devani");
        //checkOutPage.enterEmail("radhapatel50@gmail.com");
        checkOutPage.enterCompany("demo");
        checkOutPage.selectCountryFromCountryField("United Kingdom");
        checkOutPage.enterCity("London");
        checkOutPage.enterAddress("23 green road");
        checkOutPage.enterPostalCode("UB7 7JP");
        checkOutPage.enterNumber("07889564123");
        ...
        paymentInformationPage.enterCardHolderName("Prime Testing");
        paymentInformationPage.enterCardNumber("5105105105105100");
        paymentInformationPage.selectExpiryMonth("02");
        paymentInformationPage.selectExpiryYear("2025");
        paymentInformationPage.enterCardCode("769");
